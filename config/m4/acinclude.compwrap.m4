...
[
	...
	VT_WRAPPER_NVCC_VTLIB="-lvt"
	VT_WRAPPER_NVCC_VTMPILIB="-lvt-mpi"
	VT_WRAPPER_NVCC_VTMTLIB="-lvt-mt"
	VT_WRAPPER_NVCC_VTHYBLIB="-lvt-hyb"
	...
	whole_archive_flag=; no_whole_archive_flag=
	...
	as_needed_flag=; no_as_needed_flag=
	AS_IF([test x"$enable_shared" = "xyes"],
	[
		AX_CHECK_LINK_FLAG([$wl--as-needed $wl--no-as-needed],
		[
			as_needed_flag="$wl--as-needed"
			no_as_needed_flag="$wl--no-as-needed"
		])
	])

	AC_MSG_NOTICE([setup data files for compiler wrappers])

	AS_IF([test x"$whole_archive_flag" != x],
	[
		VT_WRAPPER_VTLIB="$whole_archive_flag $VT_WRAPPER_VTLIB $no_whole_archive_flag"
		VT_WRAPPER_VTMPILIB="$whole_archive_flag $VT_WRAPPER_VTMPILIB $no_whole_archive_flag"
		VT_WRAPPER_VTMTLIB="$whole_archive_flag $VT_WRAPPER_VTMTLIB $no_whole_archive_flag"
		VT_WRAPPER_VTHYBLIB="$whole_archive_flag $VT_WRAPPER_VTHYBLIB $no_whole_archive_flag"
	])

	AS_IF([test x"$as_needed_flag" != x],
	[
		VT_WRAPPER_VTLIB="$as_needed_flag $VT_WRAPPER_VTLIB $no_as_needed_flag"
		VT_WRAPPER_VTMPILIB="$as_needed_flag $VT_WRAPPER_VTMPILIB $no_as_needed_flag"
		VT_WRAPPER_VTMTLIB="$as_needed_flag $VT_WRAPPER_VTMTLIB $no_as_needed_flag"
		VT_WRAPPER_VTHYBLIB="$as_needed_flag $VT_WRAPPER_VTHYBLIB $no_as_needed_flag"
	])
	...
	AC_SUBST(VT_WRAPPER_NVCC_VTLIB)
	AC_SUBST(VT_WRAPPER_NVCC_VTMPILIB)
	AC_SUBST(VT_WRAPPER_NVCC_VTMTLIB)
	AC_SUBST(VT_WRAPPER_NVCC_VTHYBLIB)
